let apikey = "680d1343c8a8405c9ba85519250807";
...
async function successCallback(position) {
  ...
  let res = await fetch (`http://api.weatherapi.com/v1/forecast.json?key=${apikey}&q=${userlocation}&days=3`)  
  res = await res.json()
...
async function errorCallback(error) {
  let res = await fetch (`http://api.weatherapi.com/v1/forecast.json?key=${apikey}&q=Alexandria&days=3`)  
  res = await res.json()
